...
export default function Checkout() {
  ...
  const finishOrder = () => {
    ...
    window.sessionStorage.removeItem("CURRENT_LINK");
  }
                ...
                <div class="page-content">
                    ...
                    <div class="live-stream" style={{marginTop: 30}}>
                        <div class="checkout-container">
                            ...
                            <div class="product-container" id="product_container"></div>
                            ...
                            <a class="checkout" onClick={() => {finishOrder()}} style={{cursor: "pointer"}}>Checkout</a>
                        </div>
                    </div>
                </div>
            </div>
